...
public class PetLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "OperationType", "PetID", "NeedResource", "Result",
			"PetUid", "Level", "StarLevel", "Fighting" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "OperationType", "PetID", "NeedResource",
			"Result", "PetUid", "Level", "StarLevel", "Fighting", "Time" };
	private static String TBL_NAME = "tblPetLog";
