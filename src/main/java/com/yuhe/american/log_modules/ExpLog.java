...
public class ExpLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "OrgExp", "ExpChange", "CurExp", "OrgLevel",
			"CurLevel", "Reason" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "OrgExp", "ExpChange", "CurExp",
			"OrgLevel", "CurLevel", "Reason", "Time" };
	private static String TBL_NAME = "tblExpLog";
