...
public class MessageLog extends AbstractLogModule {
	...
	private static final String[] LOG_COLS = { "Uid", "SenderName", "MessageType", "Title", "Content", "Bonus" };
	private static final String[] DB_COLS = { "HostID", "Uid", "SenderName", "MessageType", "Title", "Content", "Bonus",
			"Time" };
