...
public class ActLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "ActName", "Status" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "ActName", "Status", "Time" };
	private static String TBL_NAME = "tblActLog";
