...
public class GodDoorLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "DoorType", "SubType", "Reward", "Consume" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "DoorType", "SubType", "Reward",
			"Consume", "Time" };
	private static String TBL_NAME = "tblGodDoorLog";
