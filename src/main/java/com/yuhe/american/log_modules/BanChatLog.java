...
public class BanChatLog extends AbstractLogModule {
	...
	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "OperationType", "StartTime", "BanTime", "Reason",
			"ExtInfo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Name", "Operator", "OperationType", "BanStartTime",
			"BanEndTime", "Reason", "Time", "ExtInfo" };
					...
					for (String col : LOG_COLS) {
						...
						try {
							if (col.equals("StartTime")) {
								String timeStr = DateFormatUtils.format(Long.parseLong(value + "000"),
										"yyyy-MM-dd HH:mm:ss");
