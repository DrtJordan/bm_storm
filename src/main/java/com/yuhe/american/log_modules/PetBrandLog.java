...
public class PetBrandLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "Grid", "ConsumeNum", "Level" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "Grid", "ConsumeNum", "Level", "Time" };
	private static String TBL_NAME = "tblPetBrandLog";
