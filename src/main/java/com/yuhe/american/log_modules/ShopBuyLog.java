...
public class ShopBuyLog extends AbstractLogModule {
	...
	private static final String[] LOG_COLS = { "Uid", "ShopID", "ItemID", "ItemType", "ItemName", "Currency", "Amount",
			"Price", "Memo" };
	private static final String[] DB_COLS = { "HostID", "Uid", "ShopID", "ItemID", "ItemType", "ItemName", "Currency",
			"Amount", "Price", "Memo", "Time" };
