...
public class TeamInstLog extends AbstractLogModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "Type", "StageId", "SubStageId", "Rewards" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "Type", "StageId", "SubStageId",
			"Rewards", "Time" };
	private static String TBL_NAME = "tblTeamInstLog";
